...
def train_classifier():
    ...
    QMessageBox.showinfo('Result','Training dataset completed!!!')
...
def generate_dataset(name,course,birthdate,gender,userType):
    ...
    cap.release()
    QMessageBox.showinfo('RESULT','GENERATE DATASETS SUCCESSFULLY')
...
def start_faceRG(threshold,scaleVal,neighVal): 
    ...
    def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
        ...
        for (x,y,w,h) in features:
            ...
            if confidence>threshold :
                    ...
                    function.markAttendance(userType,name)
    ...
    while True:
        ...
        img = draw_boundary(img, faceCascade,scaleVal,neighVal, (255,255,255), "Face", clf)
